...
c_ini_gA = pd.read_excel('data/clasf_jor6_gA.xlsx')
c_ini_gB = pd.read_excel('data/clasf_jor6_gB.xlsx')
calendario = pd.read_excel('data/calendario_grupos.xlsx')
jor_actual = pd.read_excel('data/jornada_7_inicial.xlsx')
jor_pasada = pd.read_excel('data/j6_actualizada.xlsx')
