...
c_ini_gA = pd.read_excel('data/clasf_jor8_gA.xlsx')
c_ini_gB = pd.read_excel('data/clasf_jor8_gB.xlsx')
calendario = pd.read_excel('data/calendario_grupos.xlsx')
jor_actual = pd.read_excel('data/jornada_9_inicial.xlsx')
jor_pasada = pd.read_excel('data/j8_actualizada.xlsx')
